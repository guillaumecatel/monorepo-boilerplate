...
- 🧪 **Testing** - Vitest with Astro Container API

### Developer Experience

- 🔥 **Hot Module Replacement** - Instant updates via Vite
- 📝 **Content Collections** - Type-safe markdown management
- 🎭 **Modular Layouts** - Flexible layout system with partials
- 🧩 **Accessible Components** - Pre-built WCAG-compliant components
...
│   │   ├── index.ts              # Middleware entry
│   │   └── paraglide.ts          # i18n routing middleware
│   │
