...
```bash
pnpm add @guillaumecatel/typescript-package
```

## 🚀 Quickstart

```typescript
import { isString, isNumber } from '@guillaumecatel/typescript-package'
// or
import { isString } from '@guillaumecatel/typescript-package/guards'
import { kebabCase } from '@guillaumecatel/typescript-package/alias'
...
import {
  ...
  isArray,
  isObject,
} from '@guillaumecatel/typescript-package/guards'
...
import {
  ...
  Primitive,
  Nullish,
} from '@guillaumecatel/typescript-package/alias'
