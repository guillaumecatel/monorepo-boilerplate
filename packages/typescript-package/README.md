...
- [License](#-license)
 ...
 ```typescript
 import { isString, isNumber, isBoolean, isArray, isObject } from '@myorg/typescript-package/guards'
 ...
 ```typescript
 import { Nullable, Maybe, Falsy, Primitive, Nullish } from '@myorg/typescript-package/alias'
 ...
 - **Publishing:** via pipeline or `pnpm publish --filter=@myorg/typescript-package`
