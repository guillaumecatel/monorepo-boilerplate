...
export default function generator(plop: PlopTypes.NodePlopAPI): void {
  ...
  plop.setGenerator('@guillaumecatel/react-package create component', {
  ...
  plop.setGenerator('@guillaumecatel/react-package create hook', {
  ...
  plop.setGenerator('@guillaumecatel/react-package sync exports', {
    description:
